...
ADR-020 is **proposed** rather than accepted, so it is not listed above. It records the durable
rationale for DEC-032 and awaits project-owner acceptance:
